        ...
        class CustomTable extends HTMLElement {
            ...
            showTotal() {
                ...
                for(var i = 0; i < indices.length; i++) {
                    ...
                    // console.log(this._dataTableObj.cell(0, indices[i]).data())
                    this._dataTableObj.cell(0, indices[i]).data(sum)
                    // console.log(sum)
                }
            }
                ...
                for(var idx = 0; idx < this._dataTableObj.rows()[0].length; idx++) {
                    ...
                    for(var i = 0; i < lcl_tableColumnNames.length; i++) {
                        ...
                        if(!lcl_nonNumericColumns.includes(i)) {
                            if(cell.data() != undefined && !lcl_masterRows_UnitConversion[idx][i].includes("%")) {
                                if(scaleTo == "M") {
