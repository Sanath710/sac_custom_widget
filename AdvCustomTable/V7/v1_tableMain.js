        ...
        class CustomTable extends HTMLElement {
            ...
            showScenarios(fixedCols, col_start_indices, top_header_names_to_show, no_of_succeeding_measures) {
                ...
                ////// Top header block to be displayed
                    ...
                    //     if(!this._fixedScenario.includes(headerNames_to_show[i])) {
                    //         var selector = "#"+headerNames_to_show[i].replace(" ", "");
                    //         // console.log(document.querySelector("v1-custom-table").shadowRoot.querySelector(selector))
                    //         if(document.querySelector("v1-custom-table").shadowRoot.querySelector(selector)) {
                    //             document.querySelector("v1-custom-table").shadowRoot.querySelector(selector).style.display = "";
                    //         }
                    //     }
                    // }
                    ...
                    //         // headerNames_to_show[0] = this._customTopHeader[0];
                    //         if(!headerNames_to_show.includes(this._customTopHeader[i])) {
                    //             // console.log(this._scenarioOrder[i])
                    //             if(this._customTopHeader[i]) {
                    //                 var selector = this._customTopHeader[i].replace(" ", "");
                    //                 // console.log(document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector), selector)
                    //                 if(document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector)) {
                    //                     document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector).style.display = "none";
                    //                 }
                    //             }
                    //         }
                    //     } else {
                    //         if(!headerNames_to_show.includes(this._scenarioOrder[i]) && document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector)) {
                    //             // console.log(this._scenarioOrder[i])
                    //             var selector = this._scenarioOrder[i].replace(" ", "");
                    //             // console.log(document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector), selector)
                    //             if(document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector)) {
                    //                 document.querySelector("v1-custom-table").shadowRoot.querySelector("#"+selector).style.display = "none";
                    //             }
