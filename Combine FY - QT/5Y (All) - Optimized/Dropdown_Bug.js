                ...
                function updateTotalOnRowUpdate_5Y_QT(updateFrom, changeLength, updateFromRowID) {
                    ...
                    for(var e = 0; e < subsetChildren.length; e++) {
                        ...
                        for(var f = updateFrom + changeLength - no_of_per_cols, idx_parent_1 = updateFrom + 4, idx_parent_2 = updateFrom + no_of_per_cols + 4; f < updateFrom + changeLength; f++) {
                            ...
                            var value = tbl.cell(parentID, idx_parent_1).data()
                            var val_minus_act = tbl.cell(parentID, idx_parent_2).data()

                            if(isNaN(value)) {
                                value = parseFloat(tbl.cell(parentID, idx_parent_1).data().replace(/,{1,}/g,"").replace(/%{1,}/g,""))
                            }
                            if(isNaN(val_minus_act)){
                                val_minus_act = parseFloat(tbl.cell(parentID, idx_parent_2).data().replace(/,{1,}/g,"").replace(/%{1,}/g,""))
                            }
                            ...
                            var value = tbl.cell(top_most_total_row_id, idx_parent_1).data()
                            var val_minus_act = tbl.cell(top_most_total_row_id, idx_parent_2).data()

                            if(isNaN(value)) {
                                value = parseFloat(tbl.cell(top_most_total_row_id, idx_parent_1).data().replace(/,{1,}/g,"").replace(/%{1,}/g,""))
                            }
                            if(isNaN(val_minus_act)){
                                val_minus_act = parseFloat(tbl.cell(top_most_total_row_id, idx_parent_2).data().replace(/,{1,}/g,"").replace(/%{1,}/g,""))
                            }
...
var start = performance.now();
                ...
                for(var e = 0; e < subTotalRowIDs.length; e++) {
                    ...
                    for(var f = 0; f < numCols_FY.length; f++) {
                        ...
                        var node = this._dataTableObj.cell(currentSubTotalRowID, numCols_FY[f]).data(nFormat.format(parseFloat(subsetTotal).toFixed(no_of_decimalPlaces)).split(".")[0]).node()
...
var start = performance.now();
                ...
                for(var e = 0; e < subTotalRowIDs.length; e++) {
                    ...
                    for(var f = 0; f < numCols_QT.length; f++) {
                        ...
                        var node = this._dataTableObj.cell(currentSubTotalRowID, numCols_QT[f]).data(parseFloat(subsetTotal).toFixed(no_of_decimalPlaces)).node()
...
var start = performance.now();
                ...
                for(var e = 0; e < subTotalRowIDs.length; e++) {
                    ...
                    for(var f = 0; f < numCols_MT.length; f++) {
                        ...
                        var node = this._dataTableObj.cell(currentSubTotalRowID, numCols_MT[f]).data(parseFloat(subsetTotal).toFixed(no_of_decimalPlaces)).node()
                ...
                for(var e = 0; e < subTotalRowIDs.length; e++) {
                    ...
                    var currentSubTotalRowID = subTotalRowIDs[e];
                        ...
                        for(var f = 0; f < numCols_5Y.length; f++) {
                            ...
                            var node = this._dataTableObj.cell(currentSubTotalRowID, numCols_5Y[f]).data(nFormat.format(parseFloat(subsetTotal).toFixed(no_of_decimalPlaces)).split(".")[0]).node()
                    ...
                    for(var i = 2; i < TOP_MOST_TOTAL_ROW.length; i++) {
...
var start = performance.now();
                ...
                for(var e = 0; e < subTotalRowIDs.length; e++) {
                    ...
                    for(var f = 0; f < numCols_5YQT.length; f++) {
                        ...
                        var node = this._dataTableObj.cell(currentSubTotalRowID, numCols_5YQT[f]).data(subsetTotal).node()
                        ...
                        TOP_MOST_TOTAL_ROW[numCols_5YQT[f]] += subsetTotal
                    }
                    ...
                    for(var f = 0; f < varCols_5YQT.length; f++) {
                        ...
                        var node = this._dataTableObj.cell(currentSubTotalRowID, varCols_5YQT[f]).data(nFormat.format(subsetTotal)).node()
                        ...
                        TOP_MOST_TOTAL_ROW[varCols_5YQT[f]] = nFormat.format(parseFloat(TOP_MOST_TOTAL_ROW[varCols_5YQT[f]].toString().replace(/,{1,}/g,"")) + subsetTotal)
                    }
                    ...
                    for(var f = 0; f < perCols_5YQT.length; f++) {
                        ...
                        var value = this._dataTableObj.cell(top_most_total_row_id, perCols_5YQT[f] - (no_of_per_cols * 2)).data()
                        var val_minus_act = this._dataTableObj.cell(top_most_total_row_id, perCols_5YQT[f] - no_of_per_cols).data()

                        if(isNaN(value)) {
                            value = parseFloat(this._dataTableObj.cell(top_most_total_row_id, perCols_5YQT[f] - (no_of_per_cols * 2)).data().replace(/,{1,}/g,"").replace(/%{1,}/g,""))
                        }
                        if(isNaN(val_minus_act)){
                            val_minus_act = parseFloat(this._dataTableObj.cell(top_most_total_row_id, perCols_5YQT[f] - no_of_per_cols).data().replace(/,{1,}/g,"").replace(/%{1,}/g,""))
                        }
                ...
                for(var i = 2; i < loopCells.length; i++) {
