...
; (function () {
        ...
        class CustomTable extends HTMLElement {
            ...
            async render_FY() {
                ...
                // document.querySelector("#__widget0 > v1-custom-table").shadowRoot.querySelector("#example > tbody > tr:nth-child(2)")
                // console.log(document.querySelectorAll("v1-custom-table"),this, )
                // this._table.style.visibility = "hidden";
