...
//  ------------------------------ TO BE UNCOMMENTED ----------------------
                        ...
                        for(var k = updateFrom; k < updateFrom + no_of_mes; k++) {
                            ...
                            for(var idx = 0; idx < subsetChildren.length; idx++) {
                                ...
                                if(!isNaN(dc)) {
                                    ...
                                    if(gbl_finalPerCols_FY[k.toString()] && gbl_finalPerCols_FY[k.toString()][0]) {
                            ...
                            if(!isNaN(dc)) {
                                ...
                                if(subsetSum == "NaN %") 
                                {
                                    tbl.cell(parseInt(parentID), k).data("- %")
                                } 
                                else {

                                    if(isNaN(subsetSum)) {
                                        subsetSum = subsetSum.split("%")[0];
                                        count = nFormat.format(subsetSum) + " %";
                                    } else {
                                        count = nFormat.format(subsetSum);
                                    }
                ...
                for(const [k, v] of Object.entries(masterObj)) {
                    ...
                    if(!onlyBaseAvailable) {
                        ...
                        this.setSelectorsSelectedValue(dropdownIDs, cga);
                    }
...
//  ------------------------------ TO BE UNCOMMENTED ----------------------
                ...
                for(const [k, v] of Object.entries(masterObj)) {
                    ...
                    if(!flag){
                        var cga = Array.from(caughtDropDownsAt);
                        master_dropdownArr = Array.from(master_dropdownArr).slice();
...
// console.log(fixRows);
            ...
            // connectedCallback() {
            //     if(this._widgetID) {
            //         console.log(">>>>>>>>>>>>>",this._widgetID);
            //         // document.querySelector(this._widgetID+"cw-combine-table").shadowRoot.querySelector("#example > tbody > tr:nth-child(1) > td.truncate").click()
            //     }
            //     // console.log(this._widgetPreviousState, "---------", this._widgetID)
            // }
        }
